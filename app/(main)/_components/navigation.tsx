...
export const Navigation = () => {
  ...
  const handleMouseMove = (e: MouseEvent) => {
    ...
    if (newWidth < 240) newWidth = 240; //Min width the sidebar can go
    if (newWidth > 480) newWidth = 480; //Max width the sidebar can go
  ...
  const resetSideBarWidth = () => {
    if (sidebarRef.current && navbarRef.current) {
      ...
      setIsResetting(true); //animate resetting of the width
